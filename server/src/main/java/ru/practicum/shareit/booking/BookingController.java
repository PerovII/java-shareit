...
public class BookingController {
    ...
    public List<BookingDto> getBookingWithState(
        ...
        log.info("Запрос списка бронирований пользователя id={}, состояние={}", userId, bookingState);
        return bookingService.getBookingsWithState(userId, bookingState);
    ...
    public List<BookingDto> getBookingsForUserItems(
            @RequestHeader(HeaderConstants.X_SHARER_USER_ID) long userId,
            @RequestParam(defaultValue = "ALL") BookingState bookingState) {
        log.info("Запрос списка бронирований для вещей пользователя id={}, состояние={}", userId, bookingState);
        return bookingService.getBookingsForUserItems(userId, bookingState);
    }
